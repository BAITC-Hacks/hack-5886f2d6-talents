...
**Версии:** C++ 1.3.0 содержит расчёт устойчивости. Готовый пакет UI пока 1.2.0
с действиями для всех клиентов; Арман пересчитывает его, Савелий подключает экран
по [контракту](team/RESILIENCE_CONTRACT.md). Самостоятельный полный прогон 1.3.0
...
Предыдущая приёмка UI: 22 теста и production-сборка прошли для поставки 1.2.0.
