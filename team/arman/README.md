...
Полный пакет пересчитан C++ 1.3.0 и проверен: 333 Python-теста без пропусков,
43 теста ядра, 34 UI-теста; три CSV не изменились. Пересчёт с проверкой — 5,660 с.
Новый экран устойчивости Савелия подключён и проверен в браузере.
